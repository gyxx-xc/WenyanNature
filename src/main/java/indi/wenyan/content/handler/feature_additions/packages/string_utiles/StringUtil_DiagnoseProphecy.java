 ...
 * @version 1.0
 * @className StringUtil_DiagnoseProphecy
 * @Description TODO
 * @date 2025/6/15 0:20
 */
public class StringUtil_DiagnoseProphecy implements JavacallHandler {
    ...
    public WenyanNativeValue handle(WenyanNativeValue[] wenyan_args) throws WenyanException.WenyanThrowException {
        ...
        return new WenyanNativeValue(WenyanType.STRING,Prophecy.diagnoseProphecy(original),false);
    }
