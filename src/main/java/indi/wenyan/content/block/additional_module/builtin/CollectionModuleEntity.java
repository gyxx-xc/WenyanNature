...
public class CollectionModuleEntity extends AbstractModuleEntity {
    ...
    private final WenyanPackage execPackage = WenyanPackageBuilder.create()
            .function(WenyanSymbol.var("CollectionModule.disjoint"), (self, args) -> {
            ...
            .function(WenyanSymbol.var("CollectionModule.contains"), (self, args) -> {
                var array = args.get(0).as(WenyanList.TYPE).value();
                var element = args.get(1);
                return WenyanValues.of(array.contains(element));
            })
            .function(WenyanSymbol.var("CollectionModule.max"), (self, args) -> {
                var array = args.getFirst().as(WenyanList.TYPE).value();
                if (array.isEmpty()) {
            ...
            .function(WenyanSymbol.var("CollectionModule.min"), (self, args) -> {
                var array = args.getFirst().as(WenyanList.TYPE).value();
                if (array.isEmpty()) {
                    return WenyanValues.of(0);
                }
