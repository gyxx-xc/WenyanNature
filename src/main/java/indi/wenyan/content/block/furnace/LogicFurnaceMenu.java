...
public class LogicFurnaceMenu extends AbstractContainerMenu {
    ...
    public LogicFurnaceMenu(int ContainerId, Inventory inv) {
    ...
    public LogicFurnaceMenu(int pContainerId,
                            Inventory inv,
                            ContainerLevelAccess access,
                            ContainerData data,
                            ItemStacksResourceHandler input,
                            ItemStacksResourceHandler output) {
        super(WyRegistration.LOGIC_FURNACE_MENU.get(), pContainerId);
    ...
    public boolean stillValid(@NonNull Player pPlayer) {
        return stillValid(access, pPlayer, WenyanBlocks.LOGIC_FURNACE_BLOCK.get());
    }
