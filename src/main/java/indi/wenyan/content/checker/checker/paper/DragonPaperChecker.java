...
//
//                to1[++num1] = i; weight1[num1] = w; next1[num1] = head1[u]; head1[u] = num1;
//                to2[++num2] = u; weight2[num2] = w; next2[num2] = head2[i]; head2[i] = num2;
//            }
//
...
//                int w = random.nextInt(1000000000) + 1;
//
//                to1[++num1] = v; weight1[num1] = w; next1[num1] = head1[u]; head1[u] = num1;
//                to2[++num2] = u; weight2[num2] = w; next2[num2] = head2[v]; head2[v] = num2;
//            }
//
//            // 4. 计算运算逻辑
