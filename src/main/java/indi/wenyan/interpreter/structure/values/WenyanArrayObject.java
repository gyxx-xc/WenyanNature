...
public record WenyanArrayObject(List<WenyanValue> values) implements WenyanObject {
    public static final WenyanType<WenyanArrayObject> TYPE = new WenyanType<>("list", WenyanArrayObject.class);
