...
@Mod(WenyanTest.MOD_ID)
public class WenyanTest {
    public static final String MOD_ID = "wenyan_test";

    public WenyanTest(IEventBus eventBus, ModContainer container) {
        // IDK, but both mek and enderIO do this, so copy OvO

        // More or less a copy of net.neoforged.neoforge.eventtest.internal.TestsMod
